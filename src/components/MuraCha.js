...
const P = [
  ...
  {id:"hojicha-floral",name:"Hojicha Tea — Floral Harmony",price:18,size:"25g",cat:"japanese",desc:"Luxury blend that offers superior quality Hojicha for a smooth, relaxing experience.\n\nMade of 100% first harvest Tencha tea, light roasted.\n\nLow in caffeine, antioxidant-rich, and controls blood sugar while still uplifting.\n\nA very special and unique blend for the perfect tea experience.",ben:["Low Caffeine","Antioxidant-Rich","Blood Sugar Control","Relaxing"],img:["https://cdn.shopify.com/s/files/1/0757/2799/5134/files/L6A2205.jpg?v=1770919693"]},
  {id:"hojicha-powder",name:"Organic Hojicha Powder",price:22,size:"40g",cat:"powders",desc:"Nutty, caramel-like taste with all-day hydration.\n\nMade of 100% organic Bancha tea in powder form.\n\nA naturally mineral-rich tea that is extremely low in caffeine — perfect for the whole family.\n\nGreat for hot or cold lattes and desserts.",ben:["Extremely Low Caffeine","Family Friendly","Mineral Rich","Great for Lattes"],img:["https://cdn.shopify.com/s/files/1/0757/2799/5134/files/L6A2204.jpg?v=1770919462"]},
  {id:"lemon-balm",name:"Organic Lemon Balm Tea",price:8,size:"Glass Jar",cat:"herbal",desc:"Known as مليسة (Melissa).\n\nA herbal tea that promotes relaxation, reduces stress, and eases PMS symptoms.\n\nComes in a beautiful glass jar with wooden spoon.",ben:["Reduces Stress","Promotes Sleep","Eases PMS","Aids Digestion"],img:["https://cdn.shopify.com/s/files/1/0757/2799/5134/files/BFF6BC9B-CC35-4E67-85FC-2522493380DB.jpg?v=1774715246"]},
  {id:"rose-puerh",name:"Rose Pu'erh Tea Bomb",price:6.5,size:"2 × 9g balls",cat:"chinese",desc:"Pu'erh tea with rose flower.\n\nSteep the ball in boiling water to enjoy an artistic experience of the blooming tea ball.",serve:"1 ball makes 4–5 cups of tea",ben:["Glowing Skin","Beauty","Pain Relief"],img:["https://cdn.shopify.com/s/files/1/0757/2799/5134/files/3.jpg?v=1761370469","https://cdn.shopify.com/s/files/1/0757/2799/5134/files/WhatsApp_Image_2025-10-30_at_5.38.55_PM.jpg?v=1763463842"]},
  {id:"tangerine-puerh",name:"Tangerine Peel Pu'erh Tea Bomb",price:6.5,size:"2 × 9g balls",cat:"chinese",desc:"Pu'erh tea with tangerine peel.\n\nSteep the ball in boiling water to enjoy an artistic experience of the blooming tea ball.",serve:"1 ball makes 4–5 cups of tea",ben:["Reduces Fat","Helps Stomach","Reduces Cough"],img:["https://cdn.shopify.com/s/files/1/0757/2799/5134/files/2.jpg?v=1761370453","https://cdn.shopify.com/s/files/1/0757/2799/5134/files/WhatsApp_Image_2025-10-30_at_5.38.55_PM_3.jpg?v=1763463821"]},
  {id:"jasmine-puerh",name:"Jasmine Pu'erh Tea Bomb",price:6.5,size:"2 × 9g balls",cat:"chinese",desc:"Pu'erh tea with jasmine flower.\n\nSteep the ball in boiling water to enjoy an artistic experience of the blooming tea ball.",serve:"1 ball makes 4–5 cups of tea",ben:["Detox","Slimming","Fresh Breath","Mood Enhancer"],img:["https://cdn.shopify.com/s/files/1/0757/2799/5134/files/IMG-9038.jpg?v=1761757578","https://cdn.shopify.com/s/files/1/0757/2799/5134/files/WhatsApp_Image_2025-10-30_at_5.38.55_PM_1.jpg?v=1763463836"]},
  {id:"chrysanthemum-big",name:"Chrysanthemum Pu'erh Tea Bomb",price:6.5,size:"2 × 9g balls",cat:"chinese",desc:"Pu'erh tea with white chrysanthemum flower.\n\nSteep the ball in boiling water to enjoy an artistic experience of the blooming tea ball.",serve:"1 ball makes 4–5 cups of tea",ben:["Anti-bacterial","Good for Eyes & Liver","Reduces Swelling"],img:["https://cdn.shopify.com/s/files/1/0757/2799/5134/files/1.jpg?v=1761370435","https://cdn.shopify.com/s/files/1/0757/2799/5134/files/WhatsApp_Image_2025-10-30_at_5.38.55_PM_2.jpg?v=1763463829"]},
...
const DEFAULT_CATS={all:"All",japanese:"Japanese",chinese:"Tea Bombs",powders:"Powders",herbal:"Herbal Tea",sweets:"Sweets"};
...
export default function App(){
  ...
  useEffect(()=>{fetch(`${SB_URL}/rest/v1/muracha_categories?order=sort_order.asc`,{headers:{"apikey":SB_KEY,"Authorization":`Bearer ${SB_KEY}`}}).then(r=>r.json()).then(data=>{if(Array.isArray(data)&&data.length>0){const c={all:"All"};data.forEach(cat=>{c[cat.id]=cat.label});setCATS(c)}}).catch(()=>{})},[]);
